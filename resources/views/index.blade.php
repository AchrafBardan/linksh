...
<div class="w-full h-screen flex flex-col items-center py-52 bg-gradient-to-bl from-indigo-400 to-indigo-500">
    ...
    <form class="flex flex-col gap-4" action="{{ route('newlink') }}" method="post">
        ...
        <button class="border-indigo-200 border-b-4 hover:bg-indigo-200 duration-300 hover:text-indigo-900 rounded-3xl py-4 px-8 bg-indigo-900 text-indigo-200" type="submit">Submitaren</button>
    </form>
</div>
