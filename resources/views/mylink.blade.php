...
<div class="w-full gap-4 h-screen flex flex-col items-center pt-20 bg-gradient-to-bl px-11 from-indigo-400 to-indigo-500">
    <a href="{{ route('home') }}"><button class="px-4 py-2 bg-indigo-200 rounded-xl  shadow-inner">Terug</button></a>
    @if ($req->link)
        <div onclick="this.style.display = 'none';" class="px-10 py-4 text-center bg-green-500 rounded-2xl">
